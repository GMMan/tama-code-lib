...
{
    /// <summary>
    /// Represents a Tama Code profile card.
    /// </summary>
    public class TamaCodeProfile : FriendTamaCode
    {
        internal TamaCodeProfile()
        {
            codeType = TamaCodeType.Profile;
        }

        public TamaCodeProfile(uint deviceId, TamaStats stats, TamaProfile profile) : base(deviceId, stats, profile)
        {
            codeType = TamaCodeType.Profile;
        }
    }
