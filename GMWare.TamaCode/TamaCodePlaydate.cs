...
{
    /// <summary>
    /// Represents a Tama Code playdate.
    /// </summary>
    public class TamaCodePlaydate : FriendTamaCode
    {
        internal TamaCodePlaydate()
        {
            codeType = TamaCodeType.Playdate;
        }

        public TamaCodePlaydate(uint deviceId, TamaStats stats, TamaProfile profile) : base(deviceId, stats, profile)
        {
            codeType = TamaCodeType.Playdate;
        }
    }
