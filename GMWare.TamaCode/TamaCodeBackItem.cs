...
{
    public class TamaCodeBackItem : FriendTamaCode, IHasItem
    {
        public short Item { get; set; }

        internal TamaCodeBackItem()
        {
            codeType = TamaCodeType.BackItem;
        }

        public TamaCodeBackItem(uint deviceId, TamaStats stats, TamaProfile profile) : base(deviceId, stats, profile)
        {
            codeType = TamaCodeType.BackItem;
        }
