...
{
    public class TamaCodeCamera : FriendTamaCode
    {
        internal TamaCodeCamera()
        {
            codeType = TamaCodeType.Camera;
        }

        public TamaCodeCamera(uint deviceId, TamaStats stats, TamaProfile profile) : base(deviceId, stats, profile)
        {
            codeType = TamaCodeType.Camera;
        }
    }
