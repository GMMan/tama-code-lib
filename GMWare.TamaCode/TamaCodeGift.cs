...
{
    /// <summary>
    /// Represents a Tama Code gift.
    /// </summary>
    public class TamaCodeGift : FriendTamaCode, IHasItem
    {
        /// <inheritdoc/>
        public short Item { get; set; }

        internal TamaCodeGift()
        {
            codeType = TamaCodeType.Gift;
        }

        public TamaCodeGift(uint deviceId, TamaStats stats, TamaProfile profile) : base(deviceId, stats, profile)
        {
            codeType = TamaCodeType.Gift;
        }
